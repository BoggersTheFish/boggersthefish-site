...
const INSTALL_STEPS = [
  ...
  },
  {
    ...
    code: "python3 -m pip install -e \".[dev]\"\n# Optional: python3 -m pip install -e \".[all,multimodal]\"",
  },
  {
    step: 3,
    title: "Configure",
    code: "# Optional: set your Ollama model in local config if needed\n# Core package runs without cloud API keys",
  },
  {
    step: 4,
  ...
  },
  {
    ...
    code: "python3 -m BoggersTheAI\n# Or run the installed console script: boggers",
  },
];
