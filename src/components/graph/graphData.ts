...
export const NETWORK_GRAPH_DATA = {
  nodes: [
    ...
    { id: "boggerstheai-repo", label: "BoggersTheAI", url: "/lineage", category: "github" as const, activation: 0.85 },
    { id: "goat-ts-repo", label: "GOAT-TS", url: "/lineage", category: "github" as const, activation: 0.75 },
    { id: "ts-core-repo", label: "TS-Core", url: "https://github.com/BoggersTheFish/TS-Core", category: "github" as const, activation: 0.78 },
    { id: "boggersmind-repo", label: "BoggersTheMind", url: "/lineage", category: "github" as const, activation: 0.7 },
    { id: "boggerspulse-repo", label: "BoggersThePulse", url: "/lineage", category: "github" as const, activation: 0.65 },
    { id: "boggeros-alpha-repo", label: "BoggersTheOS-Alpha", url: "/lineage", category: "github" as const, activation: 0.55 },
    { id: "boggeros-beta-repo", label: "BoggersTheOS-Beta", url: "/lineage", category: "github" as const, activation: 0.62 },
