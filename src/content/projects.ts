...
export const projects: Project[] = [
  ...
  },
  {
    ...
    evidence: "Published model ladder on Hugging Face plus proof-bank entries around seeded language traces and telemetry. Claims remain benchmark-bound.",
    ...
    currentState: "Public repo and model ladder exist; matched benchmark receipts need tightening.",
    nextMilestone: "Matched softmax-vs-sigmoid benchmark receipts.",
