...
export const projects: Project[] = [
  {
    ...
    nextMilestone: "Keep public release surfaces synced and expand runtime policy/recovery evidence without weakening verifier authority.",
    tags: ["verifier runtime", "policy contracts", "receipts"],
    focus: ["Runtime OS", "Typed proof boundary", "Release receipts"],
    notes: [
      "v9.8.0 added machine-readable runtime policy contracts.",
      "v9.9.0 added corrupt-checkpoint, reordered-ledger, missing-event, and restore-then-continue recovery drills.",
